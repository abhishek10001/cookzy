    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">
          Our Professional Cooks
        </h1>
        <p className="text-lg text-gray-600">
          Browse through our specialist cooks and find the perfect cook for your
          next meal
        </p>
      </div>
      ...
      {filterCooks.length === 0 ? (
        <div className="text-center py-10">
          <p className="text-lg text-gray-600">
            No chefs available for this cuisine yet. Please check back later!
          </p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="p-4">
                <div className="flex items-center gap-2 mb-2">
                  {item.available ? (
                    <div className="flex gap-1 border border-green-600 rounded-full m-2 p-1">
                      <div className=" mt-1.5 w-2 h-2 bg-green-500 rounded-full"></div>
                      <p className="text-sm text-green-600 font-medium">
                        Available
                      </p>
                    </div>
                  ) : (
                    <div className="flex gap-1 border border-red-600 rounded-full m-2 p-1">
                      <div className="mt-1.5 w-2 h-2 bg-red-500 rounded-full"></div>
