...
// // // import cooks from "../assets/assets_frontend/assets";
// // import { useNavigate } from "react-router-dom";
// // import { AppContext } from "../context/AppContext";

// // const TopCooks = () => {
// //     const navigate = useNavigate();
// //     const {cooks} = useContext(AppContext); //using usecontext hook for data getting
// //   return (
// //     <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
// //       <h1 className="text-3xl font-medium">Top Cooks to Book</h1>
...
// //         {cooks.slice(0, 10).map((item, index) => (
// //           <div onClick={()=>navigate(`/bookings/${item._id}`)} className="border border-primary rounded-xl overflow-hidden cursor-pointer">
...
// //         ))}
// //       </div>
// //       <button className=" px-10 py-3 bg-primary text-white rounded-full mt-10">
// //         View All Cooks
// //       </button>
// //     </div>
// //   );
...
//             </p>
//             <div className="w-full grid grid-cols-auto gap-4 gap-y-6 px-3 sm:px-0">
//                 {cooksList.slice(0, 10).map((item, index) => (
...
//                 ))}
//             </div>
//             <button onClick={()=> {navigate('/cooks'); scrollTo(0,0)}} className="px-10 py-3 bg-primary text-white rounded-full mt-10">
//                 View All Cooks
//             </button>
//         </div>
//     );
